                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p15t es-p15b" align="center">
                                                                <div class="esd-text">
                                                                    <h2 style="color: rgb(36, 36, 36);"><span style="font-size:30px;"><strong>The Lesson Is Canceled.</strong></span><br></h2>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text es-p10l" align="center">
                                                                <p style="color: rgb(36, 36, 36);">Hi.. {{$lesson->user->name}}<br></p>
                                                                <p style="color: rgb(36, 36, 36);">The Lesson in {{$lesson->date}} {{$lesson->time}} of {{$lesson->course->product->name}} is Canceled<br></p>
                                                                <p style="color: rgb(36, 36, 36);">Thank You<br></p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
...
{{--                                <tbody>--}}
{{--                                <tr>--}}
{{--                                    <td><span style="font-size: 18px; line-height: 200%;"><strong>Payment Amount: </strong></span></td>--}}
{{--                                    <td style="text-align: right;"><span style="font-size: 18px; line-height: 200%;"><strong>{{ $order->amount }} </strong></span><br></td>--}}
{{--                                </tr>--}}
{{--                                <tr>--}}

{{--                                    <td style="text-align: right;"><span style="font-size: 18px; line-height: 200%;">--}}
{{--                                            <a href="{{route('categoryProduct')}}" class="btn btn-default">Go To Learn Now </a></span><br></td>--}}
{{--                                </tr>--}}
{{--                                </tbody>--}}
{{--                            </table>--}}
{{--                        </td>--}}
