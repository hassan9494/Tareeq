                ...
                <form method="POST" action="{{route('admin.posts.store')}}" enctype="multipart/form-data" file="true">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">{{__('Add Service')}}</div>
                                ...
                                @foreach(config('locales') as $locale)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="subject_{{$locale}}" class="form-control" id="subject" placeholder="Enter Subject_{{$locale}}" required>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                                ...
                                @foreach(config('locales') as $locale)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="5" cols="90" maxlength="90" class="form-control"  name="sh_desc_{{$locale}}" id="desc" rows="5" required></textarea>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
