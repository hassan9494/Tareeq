                    ...
                    <tr>
                        <td class="esd-stripe" align="center">
                            <table class="es-content-body" width="600" cellspacing="0" cellpadding="0" align="center">
                                            ...
                                            <tr>
                                                <td class="esd-container-frame" width="580" valign="top" align="center">
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                        <tr>
                                                            <td class="esd-block-image" align="center"><a target="_blank"><img class="adapt-img" src="{{asset('logo/'.setting('general.logo'))}}" alt width="105"></a></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p15t es-p15b" align="center">
                                                                <div class="esd-text">
                                                                    <h2 style="color: rgb(36, 36, 36);"><span style="font-size:30px;"><strong>Your have new order.</strong></span><br></h2>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text es-p10l" align="center">
                                                                <p style="color: rgb(36, 36, 36);">Hi {{$product->user->name}}, Your have new order № {{$order->id}} please  check web site.<br></p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                ...
                                {{--                                @php $address = $order->user->address->where('id',$order->address_id)->first()@endphp--}}
                                                ...
                                                <tr>
                                                    <td class="es-m-p20b esd-container-frame" width="270" align="left">
                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                            <tbody>
                                                            <tr>
                                                                <td class="esd-block-image" align="center"><a target="_blank">
                                                                        @if($product->hasMedia('uploads'))
                                                                            <img class="adapt-img"
                                                                             src="{{ $product->firstMedia('product')->getUrl() }}" alt width="103"></a></td>
                                                                @else
                                                                    <img class="adapt-img" src="#" alt="product Image" width="103"></a></td>
                                                                @endif
                                                            </tr>
                                                            </tbody>
                                                        </table>
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                <td class="esd-block-text" align="left">
                                                                    <p><span style="font-size:16px;"><strong style="line-height: 150%;">{{ $product->name }}</strong></span></p>
                                                                    <p>
                                                                        {{ $product->variations()->where('id',$product->pivot->product_variation_id)->withTrashed()->first()->name}}
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="esd-block-text es-p20t" align="left">
                                                                    <p>
                                                                            <span style="font-size:15px;"><strong style="line-height: 150%;">Item Price:</strong><span>
                                                                                @if($product->discount)
                                                                                    {{$product->discount}}
                                                                                @else
                                                                                    {{$product->price }}
                                                                    ...
                                                                    <p><span style="font-size:15px;"><strong>Qty:</strong>{{ $product->pivot->quantity }}</span></p>
                                                                </td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
                        ...
                        <td class="esd-block-text es-p15b" align="center">
                            <table class="cke_show_border" width="240" height="101" cellspacing="1" cellpadding="1" border="0">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right;">$ {{ $order->total -  ($order->subtotal) }} </td>
                                </tr>
                                <tr>
                                    <td><span style="font-size: 18px; line-height: 200%;"><strong>Order Total: </strong></span></td>
                                    <td style="text-align: right;"><span style="font-size: 18px; line-height: 200%;"><strong>{{ $order->total }} </strong></span><br></td>
                                </tr>
                                </tbody>
                            </table>
                        </td>
                                ...
                                <tr>
                                    <td class="esd-container-frame" width="270" align="left">
                                        <table width="100%" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td class="esd-block-text" align="left">
                                                    <p><strong>{{ $order->user->address }}</strong></p>
                                                    <p>{{ $order->user->city }} , {{$order->country}} <br></p>
                                                    <p>{{$order->user->phone }}<br></p>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
