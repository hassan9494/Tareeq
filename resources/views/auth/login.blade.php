                        ...
                        <form method="POST" name="reg-form" class="register-form" action="{{ route('register') }}">
                            ...
                            <div class="row">
                                ...
                                {{-- <div class="form-group col-md-4">
                                    ...
                                    <input id="academic_year" type="text" class="form-control @error('age') is-invalid @enderror" name="academic_year" value="{{ old('academic_year') }}" required >
                                    @error('academic_year')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="whatsApp" type="text" class="form-control @error('age') is-invalid @enderror" name="whatsApp" value="{{ old('whatsApp') }}" required >
                                    @error('whatsApp')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-12">
                                <label>{{__('Preferred Paid Course Start Date')}}</label>
                                <input type="date" class="form-control " data-position="right top" name="course_start_date" placeholder="Preferred Paid Course Start Date" data-date-format="yyyy-mm-dd" data-view="months"><br>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <label>{{__('Preferred Teacher (optional)')}} </label>
                                <select name="teacher_id" id="category"
                                    ...
                                    @foreach(\App\User::where('approved',1)->where('type','teacher')->get() as $teacher)
                                        <option value="{{ $teacher->id }}">{{ $teacher->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-12">
                                <label>{{__('Preferred Course')}}</label>
