...
@section('content')
    <div class="page-inner">
        ...
        <div class="row">
            <div class="col-md-12">
                <form method="POST" action="{{route('admin.feature.store')}}" enctype="multipart/form-data" file="true">
                    @csrf
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">{{__('Add Feature')}}</div>
                                ...
                                @foreach(config('locales') as $locale)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                                ...
                                                <input type="text" name="title_{{$locale}}" class="form-control" id="title_" placeholder="Enter {{ $locale == 'en'? __('English Name') : __('Arabic Name') }}" required>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                                ...
                                <div class="col-md-12 col-lg-12">
                                    @foreach(config('locales') as $locale)
                                        <div class="form-group">
                                            ...
                                            <textarea rows="5" cols="80" maxlength="120" class="form-control" name="desc_{{$locale}}" id="desc" required></textarea>
                                        </div>
                                    @endforeach
